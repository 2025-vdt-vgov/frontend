...
export function AppSidebar() {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/', icon: LayoutDashboard, roles: ['admin', 'pm'] as UserRole[] },
    { name: 'Dự án của tôi', href: '/', icon: Folder, roles: ['employee'] as UserRole[] },
    { name: 'Dự án', href: '/projects', icon: Folder, roles: ['pm', 'admin'] as UserRole[] },
    { name: 'Nhân sự', href: '/employees', icon: Users, roles: ['pm', 'admin'] as UserRole[] },
    { name: 'PM Tools', href: '/pm-tools', icon: Key, roles: ['admin'] as UserRole[] },
    { name: 'Báo cáo', href: '/reports', icon: BarChart, roles: ['pm', 'admin'] as UserRole[] },
    ...
    <Sidebar className="border-r bg-sidebar">
      <SidebarHeader className="p-4">
        <div className="flex items-center">
          ...
          {!isCollapsed && (
            <div className="ml-3">
              <h1 className="text-xl font-bold text-sidebar-foreground">PM Dashboard</h1>
            </div>
          )}
        </div>
      </SidebarHeader>
