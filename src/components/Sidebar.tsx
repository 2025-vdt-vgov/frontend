...
const Sidebar = ({ userRole }: SidebarProps) => {
  const navigation = [
    { name: 'Dashboard', href: '/', icon: LayoutDashboard, roles: ['employee', 'pm', 'admin'] },
    ...
    { name: 'Báo cáo', href: '/reports', icon: BarChart, roles: ['pm', 'admin'] },
      ...
      <div className="flex flex-col flex-grow pt-5 bg-gradient-to-b from-blue-900 to-blue-800 overflow-y-auto">
        <div className="flex items-center flex-shrink-0 px-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h1 className="text-xl font-bold text-white">PM Dashboard</h1>
            </div>
          </div>
        </div>
